...
font-family:"Times New Roman","serif"'>DECLARACION JURADA DE NO POSEER VIVIENDA</span></b></p>
...
font-family:"Times New Roman","serif"'>Quienes suscriben, los abajo firmantes; Voceros y Voceras del Concejo Comunal <b>“{{$censos->nomb_comunidad}}”</b>, Parroquia Altagracia, Municipio José Tadeo Monagas del Estado Guárico, Por medio de la presente hacemos certificamos que el ciudadano(a) <b>{{$censos->name}}</b>,titular de la Cedula de Identidad N°<b>V-{{$censos->cedula}}</b>,de Profesión u ocupación:  <b>{{$censos->grado_instrucion}}</b>,  esta residenciado en  <b>{{$censos->direccion}}</b>, desde aproximadamente hace aproximadamente <b>31años</b>,
damos fe de que no posee vivienda propia en esta dirección ni en ninguna jurisdicción. </span></p>

<p class=MsoNormal style='margin-top:12.0pt;text-align:justify;text-indent:
35.4pt;line-height:200%'><span style='font-size:12.0pt;line-height:200%;
font-family:"Times New Roman","serif"'>Solicitud a petición de parte interesada en Altagracia de Orituco, a los  14 días  del mes de septiembre del año 2016.</span></p>

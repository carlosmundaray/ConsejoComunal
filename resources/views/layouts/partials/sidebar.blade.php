...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="#"><i class='fa fa-briefcase'></i><span> Censo </span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="{{ url('censo/create') }}">Registro</a></li>
                    <li><a href="{{ url('censo') }}">Consulta</a></li>
                </ul>
            </li>            
            <li class="treeview">
